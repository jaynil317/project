...
def page():
    ...
    cursor.execute('SELECT program FROM users WHERE email= %s',(mainemail,))
    program= cursor.fetchone()
    cursor.execute('SELECT course FROM users WHERE email = %s',(mainemail,))
    course= cursor.fetchone()
    cursor.execute('SELECT gender FROM users WHERE email = %s',(mainemail,))
    gender= cursor.fetchone()
    cursor.execute('SELECT email FROM users WHERE email = %s',(mainemail,))
    email= cursor.fetchone()
    cursor.execute('SELECT phone FROM users WHERE email = %s',(mainemail,))
    phone= cursor.fetchone()
    cursor.execute('SELECT dob FROM users WHERE email = %s',(mainemail,))
    dob= cursor.fetchone()
    cursor.execute('SELECT address FROM users WHERE email = %s',(mainemail,))
    address= cursor.fetchone()
    cursor.execute('SELECT city FROM users WHERE email = %s',(mainemail,))
    city= cursor.fetchone()
    cursor.execute('SELECT state FROM users WHERE email = %s',(mainemail,))
    state= cursor.fetchone()
    cursor.execute('SELECT tenth FROM users WHERE email = %s',(mainemail,))
    tenth= cursor.fetchone()
    cursor.execute('SELECT twelfth FROM users WHERE email = %s',(mainemail,))
    twelfth= cursor.fetchone()
    cursor.execute('SELECT year FROM users WHERE email = %s',(mainemail,))
    year= cursor.fetchone()
    cursor.execute('SELECT avggpa FROM users WHERE email = %s',(mainemail,))
    avggpa= cursor.fetchone()
    cursor.execute('SELECT institute FROM users WHERE email = %s',(mainemail,))
    institute= cursor.fetchone()
    cursor.execute('SELECT teckskills FROM users WHERE email = %s',(mainemail,))
    teckskills= cursor.fetchone()
    cursor.execute('SELECT nontechskills FROM users WHERE email = %s',(mainemail,))
    nontechskills= cursor.fetchone()
    cursor.execute('SELECT internships FROM users WHERE email = %s',(mainemail,))
    internships= cursor.fetchone()
    cursor.execute('SELECT projects FROM users WHERE email = %s',(mainemail,))
